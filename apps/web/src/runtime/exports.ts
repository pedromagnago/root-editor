...
export function buildDesignManifestContent(opts: {
  ...
  const title = opts.title || 'Root Editor artifact';
...
- Keep generated product UI free of Root Editor chrome, preview labels, or design-process annotations.
...
- Do not keep prototype-only annotations, frame labels, or Root Editor chrome in the production UI.

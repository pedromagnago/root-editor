...
export const SHARE_TO_COMMUNITY_PROMPT = [
  'Package the work I just finished in this project as a Root Editor plugin so I can install it into My plugins and open a PR to the Root Editor community catalog.',
  '',
  ...
  '- **Root Editor PR** — opens a draft PR against `nexu-io/open-design` for the community catalog.',
  '',

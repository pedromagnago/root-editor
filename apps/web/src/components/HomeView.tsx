...
const AUTHORING_DEFAULT_SCENARIO_INPUTS = {
  artifactKind: 'Root Editor plugin',
  audience: 'Root Editor plugin authors',
  topic: 'packaging a reusable workflow as a Root Editor plugin',
};
...
export function HomeView({
  ...
  async function handlePickWorkingDir() {
    ...
    if (isOpenDesignHostAvailable()) {
      ...
      setError(
        `Couldn't open the folder picker (${'reason' in result ? result.reason : 'host unavailable'}). Please update Root Editor and try again.`,
      );
      return null;
    }

...
export const en: Dict = {
  ...
  'chat.amrCard.switchBody': 'Switch to Root Editor — no API key setup needed. After you sign in, authorize, and top up, this run retries automatically.',
  ...
  'chat.amrCard.switchCta': 'Switch to Root Editor & retry',
  'chat.amrError.authMessage': 'Your Root Editor account isn\'t authorized yet. Authorize it and this run retries automatically.',
  'chat.amrError.balanceMessage': 'Your Root Editor balance has run out. Top up to keep this run going.',
  ...
  'chat.runError.signInMessage.amr': 'The Root Editor agent isn\'t signed in yet — sign in to start using it.',
  'chat.runError.signInMessage.other': '{agent} isn\'t signed in. Check its sign-in status locally. We recommend the Root Editor agent — steadier and better value.',
  ...
  'settings.welcomeTitle': 'Welcome to Root Editor',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'Start from a brief',
  'settings.onboardingCreateBody': 'Describe the site, app, deck, image, or video you want. Root Editor will create a project and keep the work editable.',
  ...
  'settings.onboardingMemoryCalloutBody': 'These answers seed your Memory profile. Root Editor reuses it on every task — and keeps learning as you work.',
  ...
  'settings.onboardingAmrModelSourceLabel': 'Root Editor',
  ...
  'settings.onboardingGateTooltipAmr': 'The next steps run on AI — sign in to Root Editor to continue.',
  ...
  'settings.agentInstall.pathHint': 'If you installed a CLI with npm or Homebrew and it still shows as not installed, ensure the tool\'s bin directory is on the PATH the Root Editor daemon inherits (Terminal vs GUI apps can differ on macOS). See QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Open Install or Docs for your preferred agent.',
  'settings.agentInstall.stepAuth': 'Authenticate with the vendor CLI (sign in or add API credentials) before returning to Root Editor.',
  ...
  'settings.amrAccountStatus': 'Root Editor account status',
  ...
  'settings.mcpServerHint': 'Expose Root Editor as an MCP server for your coding agent.',
  ...
  'settings.privacyHint': 'What data is shared with the Root Editor team',
  'settings.privacyConsentKicker': 'Help us improve Root Editor',
  'settings.privacyConsentLead': 'Root Editor can share usage data with our team to help us improve. This includes:',
  ...
  'settings.updateQuitFailed': 'The installer opened, but Root Editor could not quit automatically.',
  ...
  'settings.mcpHint': 'Let coding agents (Cursor, Claude Code, VS Code…) read your Root Editor projects directly.',
  'settings.mcpDaemonError': 'Couldn\'t reach the local daemon to resolve install paths ({error}). Make sure Root Editor is running, then reopen this panel.',
  ...
  'settings.mcpCapabilityDefault': 'Default to the project and file you have open in Root Editor, so you can say "build this in my app" without re-stating which design.',
  'settings.mcpRunningNote': 'Root Editor must be running for MCP tool calls to succeed. If you started your coding agent before opening Root Editor, restart the agent so it can reach the live daemon.',
  ...
  'entry.discordAria': 'Join the Root Editor Discord',
  'entry.discordAriaWithOnline': 'Join the Root Editor Discord - {online}',
  'entry.discordOnlineLabel': '{count} online',
  'entry.followXLabel': 'Follow @root on X',
  'entry.followThreadsLabel': 'Follow Root Editor on Threads',
  'entry.youtubeLabel': 'Root Editor on YouTube',
  'entry.followInstagramLabel': 'Follow @root on Instagram',
  'entry.followLinkedinLabel': 'Follow Root Editor on LinkedIn',
  'entry.followXiaohongshuLabel': 'Follow Root Editor on Xiaohongshu',
  ...
  'homeHero.chip.createPluginHint': 'Author a reusable Root Editor plugin and add it to My plugins.',
  ...
  'handoff.amrWebsite': 'Visit Root Editor',
  ...
  'handoff.promptIntro': 'Continue from this local Root Editor project folder:',
  ...
  'pluginsHome.subtitle': 'Ready-to-use Root Editor workflows bundled with this runtime. Pick one to load a starter prompt, or browse the registry for more.',
  'pluginsHome.browseRegistry': 'Browse registry',
  'pluginsHome.count': '{filtered} of {total}',
  'pluginsHome.loadingCatalog': 'Loading catalog…',
  'pluginsHome.emptyCatalog': 'Catalog is empty. Bundled plugins ship with Root Editor and should appear here automatically — try restarting the daemon if this persists.',
  ...
  'pluginCard.contributeAria': 'Contribute {title} to Root Editor',
  'pluginCard.contributeTitle': 'Contribute plugin to Root Editor with a pull request',
  'skillPluginCandidate.createForMe': 'Create plugin/template',
  'skillPluginCandidate.contributeToMain': 'Contribute to root-editor',
  'skillPluginCandidate.repoDescription': 'This repo looks like it could work as a plugin.',
  'integrations.kicker': 'Integration',
  'integrations.lede': 'Connect external systems, bring MCP tools into your agent loop, and use Root Editor from other IDEs, scripts, and automations.',
  ...
  'mcpClient.daemonError': 'Could not reach the local daemon. Make sure Root Editor is running, then reopen this panel.',
  'mcpClient.saveFailed': 'Save failed. Check that the daemon is running and try again.',
  'useEverywhere.modalAria': 'Use Root Editor everywhere',
  'useEverywhere.modalTitle': 'Use Root Editor everywhere',
  'useEverywhere.modalSubtitle': 'Drop Root Editor into any IDE, agent, or script — CLI, HTTP, MCP, and Skills. Use “Copy guide for an agent” and paste into Claude Code, Codex, Cursor, openclaw, or hermes to set up everything.',
  ...
  'useEverywhere.section.overview.heading': 'Root Editor works wherever your agent works',
  'useEverywhere.section.overview.intro': 'Root Editor is more than a window — it is a local privileged daemon (`od`) plus a Skills + Design-Systems + Atoms registry. Once it is running on your machine, any code agent (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, your own script) can drive generations, inspect projects, and produce design artifacts through four interchangeable surfaces.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` for headless scripts, CI, and shell automation.',
  'useEverywhere.section.overview.bullet2': 'MCP server — wires Root Editor as a Model Context Protocol server so any MCP-capable agent can list skills, run scenarios, and read artifacts.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — drop-in `SKILL.md` packs (Claude-compatible) that any agent already on your PATH can invoke without Root Editor at all.',
  ...
  'useEverywhere.section.cli.heading': 'Drive Root Editor from any shell',
  ...
  'useEverywhere.section.mcp.heading': 'Expose Root Editor as an MCP server to any coding agent',
  'useEverywhere.section.mcp.intro': 'Root Editor ships with a Model Context Protocol server (`od mcp`) that lets any MCP-capable client — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — discover Root Editor tools (list skills, render previews, generate media, run plugins) without shelling out manually. The daemon publishes a ready-to-paste install snippet via `GET /api/mcp/install-info` for each major client.',
  ...
  'useEverywhere.section.mcp.footer': 'In the Root Editor app, open Settings → Integrations to copy a client-specific install command (Cursor, Claude Code, Antigravity, VS Code) instead of editing JSON by hand.',
  ...
  'useEverywhere.section.skills.heading': 'Drop-in Skills for any agent — even without Root Editor running',
  'useEverywhere.section.skills.intro': 'A Skill is a directory with a Claude-compatible `SKILL.md` (YAML front-matter + body). Root Editor extends the format with the `od:` namespace (`mode`, `preview`, `design_system`, `inputs`, …) so the same artifact can be used both inside Root Editor and by a vanilla agent like Claude Code, Codex, openclaw, or hermes. Discovery follows a precedence chain so projects can override their own skills.',
  ...
  'useEverywhere.section.skills.snippet1': 'Minimal SKILL.md (Claude-compatible front matter + Root Editor extras)',
  ...
  'entry.githubStarAria': 'Star Root Editor on GitHub',
  ...
  'newproj.locationDefault': 'Root Editor projects',
  ...
  'socialShare.openDesignSection': 'Share Root Editor',
  'socialShare.openDesignTitle': 'Root Editor on GitHub',
  'socialShare.openDesignText': 'Root Editor is an open-source workspace for creating, editing, deploying, and handing off design artifacts.',
  ...
  'socialShare.projectText': 'Built with Root Editor: {title}. View the deployed artifact and star the repo: {repo}',
  'socialShare.projectCopyText': 'Built with Root Editor: {title}\n{url}\nRoot Editor repo: {repo}',
  ...
  'brandEnrichment.body': "Root Editor will run a deeper extraction in the background, apply the right design-system skills automatically, and update this system in place. This can take 10-20 minutes; you can keep working.",
  ...
  'chat.activeFilePlaceholder': 'Ask Root Editor to change {file}...',
  ...
  'chat.mode.design.solves': 'Use it when you want Root Editor to generate files, update the workspace, or turn a brief into multimodal deliverables.',
  ...
  'preview.errorBody': 'The example HTML failed to fetch. Make sure Root Editor is running and try again.',
  'preview.retry': 'Retry',
  ...
  'designFiles.usefulInfoTip7': 'Enjoying Root Editor? Star us on GitHub.',
  'designFiles.usefulInfoTip8': 'Follow @root on X for the latest updates.',
  ...
  'designFiles.usefulInfoTip16': 'Follow @root on Threads for behind-the-scenes updates.',
  'designFiles.usefulInfoTip17': 'Follow @root on Instagram for design inspiration.',
  'designFiles.usefulInfoTip18': 'Subscribe to Root Editor on YouTube for tutorials and demos.',
  'designFiles.usefulInfoTip19': 'Follow Root Editor on LinkedIn for product news.',
  'designFiles.usefulInfoTip20': 'Follow Root Editor on Xiaohongshu for tips and inspiration.',
  ...
  'assistant.shareToOpenDesign': 'Share to Root Editor',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with Root Editor — pick one and adopt.',
  ...
  'pet.codexBundledTitle': 'Ships with Root Editor — no download needed.',
  ...
  'settings.projectLocationsDescription': 'Add work bases that can contain multiple Root Editor project folders. New projects are saved as one folder inside the selected base.',
  ...
  'settings.customInstructionsHint': 'Fixed instructions Root Editor should follow in every chat. Save facts, preferences, and project context as memories.',
  ...
  'updater.availableBody': 'Root Editor {version} is available. It will download before the installer can open.',
  ...
  'updater.installerOpenBody': 'The installer is open. Root Editor is quitting so you can finish the update.',
  ...
  'updater.quitButton': 'Quit Root Editor',
  'updater.quitFailedBody': 'The installer is open, but Root Editor could not quit. Quit Root Editor before replacing the app.',
  'updater.quitFailedTitle': 'Could not quit',
  'updater.quitting': 'Quitting...',
  'updater.ready': 'Update ready',
  'updater.readyGeneric': 'A new version is ready. Root Editor will close and open the installer.',
  'updater.readyVersion': 'Root Editor {version} is ready. Root Editor will close and open the installer.',
  ...
  'dsManager.createBody': 'Teach Root Editor your brand, product, code, assets, and design references.',
  ...
  'settings.customInstructionsDesc': 'Fixed instructions Root Editor follows in every chat. These are not saved memories; use Memory for facts, preferences, and project context.',
  ...
  'brand.librarySubtitle': 'Teach Root Editor your design systems — extract one from a website, then apply it in any chat.',
  ...
  'onboarding.buildBody': 'Root Editor turns your brand into a reusable design system — then keeps everything you build on-brand and consistent.',

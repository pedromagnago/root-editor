...
export interface Dict {
  ...
  'settings.skillsConfig': string;
  'settings.skillsConfigFailed': string;
  'settings.skillsConfigSaving': string;
  ...
  'carouselEditor.open': string;
  'carouselEditor.title': string;
  'carouselEditor.close': string;
  'carouselEditor.loading': string;
  'carouselEditor.loadFailed': string;
  'carouselEditor.retry': string;
  'carouselEditor.slides': string;
  'carouselEditor.typeCapa': string;
  'carouselEditor.typeConteudo': string;
  'carouselEditor.typeFechamento': string;
  'carouselEditor.noHeadline': string;
  'carouselEditor.moveUp': string;
  'carouselEditor.moveDown': string;
  'carouselEditor.coverLocked': string;
  'carouselEditor.closingLocked': string;
  'carouselEditor.addSlide': string;
  'carouselEditor.addSlideMax': string;
  'carouselEditor.removeSlide': string;
  'carouselEditor.removeSlideMin': string;
  'carouselEditor.fieldTag': string;
  'carouselEditor.fieldHeadline': string;
  'carouselEditor.fieldBlock1': string;
  'carouselEditor.fieldBlock2': string;
  'carouselEditor.fieldSource': string;
  'carouselEditor.fieldBg': string;
  'carouselEditor.bgLight': string;
  'carouselEditor.bgDark': string;
  'carouselEditor.bgGradient': string;
  'carouselEditor.bgAlert': string;
  'carouselEditor.fieldCtaInstrucao': string;
  'carouselEditor.fieldCtaPalavra': string;
  'carouselEditor.fieldCtaBeneficio': string;
  'carouselEditor.componentsBadge': string;
  'carouselEditor.componentsHint': string;
  'carouselEditor.imageRef': string;
  'carouselEditor.markupHint': string;
  'carouselEditor.unsaved': string;
  'carouselEditor.save': string;
